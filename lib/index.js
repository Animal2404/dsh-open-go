...
async function launchChrome() {
  ...
  let child
  try {
    child = spawn(shell, ['-NoProfile', '-ExecutionPolicy', 'Bypass', '-File', ps1, '-Port', String(CHROME_DEBUG_PORT), '-Url', 'https://opencode.ai/workspace/'], { stdio: 'ignore', windowsHide: true })
  } catch (e) { return null }
