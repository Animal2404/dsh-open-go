...
/**
 * dsh-opencode-quota（浏览器端）v0.9.5
 *
...
const CSS = [
  ...
  '.dshoq-scope{--oq-main:var(--dsw-alias-label-primary,#e6edf7);--oq-muted:var(--dsw-alias-label-secondary,#8fa3bf);--oq-track:var(--dsw-alias-border-l2,rgba(127,127,127,.22));--oq-line:var(--dsw-alias-border-l2,rgba(127,127,127,.35));--oq-hover:var(--dsw-alias-interactive-bg-hover,rgba(127,127,127,.08));--oq-chip:var(--dsw-alias-interactive-bg-active,rgba(127,127,127,.14));--oq-acrylic:var(--dsw-alias-button-elevated-fill,#2a2a2f);--oq-acrylic-hover:var(--dsw-alias-button-floating-hover,rgba(127,127,127,.16));--oq-acrylic-active:var(--dsw-alias-interactive-bg-active,rgba(127,127,127,.2));--oq-overlay:var(--dsw-specific-menu,var(--dsw-alias-bg-layer-3,#232327));--oq-dialog:var(--dsw-alias-bg-layer-2,#1e1e20);--oq-card:var(--dsw-alias-interactive-bg-hover,rgba(127,127,127,.06));--oq-elev1:var(--dsw-shadow-lv1,0 2px 4px rgba(0,0,0,.06));--oq-elev2:var(--dsw-shadow-lv2,0 4px 12px rgba(0,0,0,.06));--oq-elev3:var(--dsw-shadow-lv3,0 12px 32px rgba(0,0,0,.1));--oq-mask:var(--dsw-alias-bg-mask-1,rgba(0,0,0,.4));--oq-field:var(--dsw-alias-bg-layer-1,#26262a);--oq-field-line:var(--dsw-alias-border-l2,rgba(127,127,127,.35));--oq-accent:var(--dsw-alias-brand-primary-new-colorprimary-new-color,#4d6bfe);--oq-strong:var(--dsw-alias-button-ghost-active-fill,rgba(127,127,127,.22));--oq-strong-hover:var(--dsw-alias-button-ghost-active-hover,rgba(127,127,127,.3));--oq-knob:var(--dsw-static-neutral-bluish-00,#fff);--oq-edge:light-dark(var(--dsw-alias-border-l2,rgba(0,0,0,.1)),transparent);color:var(--oq-main);font:12px/1.5 -apple-system,BlinkMacSystemFont,"Segoe UI","Microsoft YaHei",sans-serif;font-variant-numeric:tabular-nums}',
  ...
  '.dshoq-card{display:flex;flex-direction:column;gap:8px;border-radius:10px;padding:8px;background:var(--oq-card)}',
